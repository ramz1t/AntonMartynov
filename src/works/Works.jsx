...
const Works = () => {
    ...
    const works = [
        ...
        },
        {
            ...
            name_big: null,
            title: 'MARTINI',
            text: "A video diary following Boris Zarkov, one of Russia's most prominent restaurateurs, on a journey through Piedmont, the birthplace of MARTINI. Searching for inspiration, he retraces the origins of his relationship with the brand, moving through the landscapes, people, and places that shaped it. Framed around Zarkov's own notes, observations, and reflections along the way.\nOriginal narration in Russian. This version uses an AI-generated voice-over closely matching the original. Full film available on request.",
            extra_fields: [
                ['agency', 'journey'],
                ['role', 'editing'],
            ],
        ...
        {
            preview_small: 'form2.jpg',
            video_small: 'form2.mp4',
            id_small: 1210001725,
            name_small: null,
            preview_big: 'form1.jpg',
            video_big: 'form1.mp4',
            id_big: 1210001724,
            name_big: null,
            title: 'SHORT-FORM',
